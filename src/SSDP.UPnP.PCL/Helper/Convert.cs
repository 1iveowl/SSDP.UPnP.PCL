...
namespace SSDP.UPnP.PCL.Helper
{
    ...
    {
        internal static int GetMaxAge(IReadOnlyDictionary<string, string> headers)
        {
        ...
        internal static TransportType GetCastMetod(HttpRequestResponse request)
        {
            switch (request.Transport)
            {
                case HttpTransport.Tcp: return TransportType.Unicast;
                case HttpTransport.Udp: return TransportType.Multicast;
